...
return {
  {
    ...
    dependencies = {
      ...
      -- NOTE: Must be loaded before dependencies
      ...
      -- TODO: Move comments like the one above to the documentation folder.
    ...
    config = function()
      ...
      --  NOTE: Make sure you have installed npm/node, as it's needed for some LSP servers.
      --  Also make sure to install go, as it's needed for other LSP servers.
